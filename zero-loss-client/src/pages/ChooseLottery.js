...
import { Statistic, Row, Col, Card, Modal, Tag, Button, Result, Typography, Tabs, Empty } from 'antd';
                  ...
                  <Col span={8} style={{ marginTop: '20px' }}>
                    <Card className="shadow" style={{ margin: '10px' }}>
                      ...
                      <Row>
                        ...
                        <Col span={15}>{new Date(1632441600 * 1000).toLocaleString()}</Col>
                      </Row>
                      <Row style={{ paddingTop: '10px' }}>
                        <Col span={9}>
                          <Tag color="green">Lock Date:&nbsp;</Tag>
                        </Col>
                        <Col span={15}>{new Date(1633046400 * 1000).toLocaleString()}</Col>
                      </Row>
                      <Row style={{ paddingTop: '10px' }}>
                        <Col span={9}>
                          <Tag color="magenta">End Date:&nbsp;&nbsp;</Tag>
                        </Col>
                        <Col span={15}>{new Date(1635561600 * 1000).toLocaleString()}</Col>
                      </Row>
                      ...
                      <p style={{ display: 'root-flow' }}>
                        <span style={{ float: 'left' }}>
                          <Text type="danger">
                            <span style={{ fontWeight: 'bold' }}>85</span> tickets sold till now
                          </Text>
                        </span>
                        <Link
                          to={{
                            ...
                            //   lottery: item,
                            //   coin: coin,
                            //   coin_lottery_addr: coinLotteryDetails.coin_lottery_addr,
                            //   coin_eth_addr: coinLotteryDetails.coin_eth_addr,
                            //   coin_c_eth_addr: coinLotteryDetails.coin_c_eth_addr
                            //   //the lottery contract address has to be sent from here.
                            // }
                          }}
                        >
